...
$smilies_config_image_size = 245760;		// max upload image size in bytes
$smilies_config_image_width = 128;			// max upload image width in pixels
$smilies_config_image_height = 128;		// max upload image height in pixels
...
?>
										...
										<td><input type="text" name="smilies_code[<?php echo $db_smilies['id'] ?>]" value="<?php echo pun_htmlspecialchars($db_smilies['text']) ?>" size="20" maxlength="60" /></td>
