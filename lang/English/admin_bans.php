...
'Invalid date reasons'		=>	'The ban time format is based on seconds. You can add signs of multiplication and such. 1440 * 60 means 1 day. Check you didn\t add anything beyond it.',
...
'Expire date help'			=>	'The time (in minutes) when this ban should be automatically removed. Leave blank to remove manually.',
